...
Это фронтенд-проект на Nuxt 3 для сайта ItGraf. Основная задача — адаптация компонентов и моделей под читаемую структуру, а также замена всех оранжевых акцентов на новый цвет `#103e3c`.
